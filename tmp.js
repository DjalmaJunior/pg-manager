  ...
  async getDataToFix (dbConfig) {
    ...
    try {
      ...
      for (row of res.rows) {
        ...
        console.log('modeloBase:', dthMovimentacao, JSON.stringify(modeloBase))
        ...
        const novaVersao = {
          ...
          status_vencido: modeloBase.status_vencido,
          status_liberado: modeloBase.status_liberado,
          cod_codigo_barras_estoque: modeloBase.cod_codigo_barras_estoque,
          cod_lote: modeloBase.cod_lote,
          ind_uso: modeloBase.ind_uso,
          ...
          is_insumo: modeloBase.is_insumo,
        ...
        await client.query(/* sql */`
          ...
          SET 
            cod_versao_estoque = ${versaoUpdated.rows[0].seq_versao_estoque}
